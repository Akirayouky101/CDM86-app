-- ============================================================================
-- TEST MLM COMPLETO - CON AUTH USERS
-- ============================================================================
-- Questo test crea utenti completi (auth.users + public.users + user_points)
-- per simulare una registrazione reale e testare il sistema MLM
-- ============================================================================
...
-- ============================================================================
-- CLEANUP (OPZIONALE - ESEGUI SOLO SE VUOI RIMUOVERE I DATI DI TEST)
-- ============================================================================

/*
-- ATTENZIONE: Questo cancella tutti i dati di test creati!
-- Decommenta solo se vuoi pulire dopo il test
...
SELECT '🗑️ Cleanup completato!' as status;
*/
