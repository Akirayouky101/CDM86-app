...
CREATE POLICY "Users can manage own favorites" ON favorites FOR INSERT USING (auth.uid() = user_id);
...
CREATE POLICY "Users can create redemptions" ON promotion_redemptions FOR INSERT USING (auth.uid() = user_id);
