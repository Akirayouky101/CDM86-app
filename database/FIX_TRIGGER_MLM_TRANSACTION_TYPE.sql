-- ============================================================================
-- FIX FINALE TRIGGER MLM - transaction_type è NOT NULL
-- ============================================================================
-- La colonna si chiama "transaction_type" ed è NOT NULL
-- Devo includerla nel trigger
-- ============================================================================
...
BEGIN
  IF NEW.referred_by_id IS NOT NULL THEN
    ...
    -- Registra transazione con transaction_type
...
BEGIN
  ...
  INSERT INTO points_transactions (user_id, points, transaction_type, description)
  VALUES (v_referrer_id, v_points_awarded, 'referral',
  ...
  IF v_referrer_of_referrer_id IS NOT NULL THEN
    ...
    -- Con transaction_type
    INSERT INTO points_transactions (user_id, points, transaction_type, description)
    VALUES (v_referrer_of_referrer_id, v_points_awarded, 'referral',
...
-- Log successo
SELECT '✅ Trigger MLM fixato - Aggiunto transaction_type' as status;
