-- ═══════════════════════════════════════════════════════════════════
-- FIX: abandon_collaborator_role - rimuove crypt/gen_salt (pgcrypto)
-- La password viene cambiata dal frontend via Supabase Auth Admin API
-- (updateUserById) dopo che questa funzione ritorna la new_password
-- ═══════════════════════════════════════════════════════════════════
...
BEGIN
    ...
    -- ══════════════════════════════════════════════════════════════
    -- 3. Genera nuova password casuale (8 caratteri alfanumerici)
    --    La password NON viene applicata qui: viene ritornata al
    --    frontend che la applica via Supabase Auth Admin API
    --    (updateUserById) per evitare dipendenza da pgcrypto
    -- ══════════════════════════════════════════════════════════════
    ...
    -- ══════════════════════════════════════════════════════════════
    -- 7. Aggiorna metadata auth e public.users per rimuovere ruolo
    -- ══════════════════════════════════════════════════════════════
    UPDATE auth.users
    ...
    -- ══════════════════════════════════════════════════════════════
    -- 8. Ritorna risultato (inclusa new_password per il frontend)
    -- ══════════════════════════════════════════════════════════════
    RETURN json_build_object(
        'success', true,
