-- ═══════════════════════════════════════════════════════════════════
-- FIX: abandon_collaborator_role - sostituisce gen_random_bytes con MD5
-- (gen_random_bytes richiede pgcrypto che non è disponibile)
-- ═══════════════════════════════════════════════════════════════════
...
BEGIN
    ...
    --    Usa MD5 invece di gen_random_bytes (non richiede pgcrypto)
    -- ══════════════════════════════════════════════════════════════
