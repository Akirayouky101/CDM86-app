-- ═══════════════════════════════════════════════════════════════════
-- FIX: abandon_collaborator_role - rimuove session_replication_role
-- (non disponibile su Supabase cloud, richiede superuser)
-- Il trigger award_referral_points_mlm è già stato corretto (_0009)
-- per gestire il caso referred_by_id non presente in auth.users,
-- quindi non serve più bypassare i trigger.
-- ═══════════════════════════════════════════════════════════════════
...
BEGIN
    ...
    --    NOTA: il trigger award_referral_points_mlm si attiva solo
    --    quando OLD.referred_by_id IS NULL → qui è già valorizzato
    --    quindi il trigger non farà nulla (check interno al trigger)
    -- ══════════════════════════════════════════════════════════════
    WITH level_1 AS (
    ...
    -- ══════════════════════════════════════════════════════════════
    -- 7. Rimuove ruolo collaboratore da public.users e auth.users
    -- ══════════════════════════════════════════════════════════════
    UPDATE public.users
    SET
    ...
    -- ══════════════════════════════════════════════════════════════
    -- 8. Ritorna risultato con la nuova password per il frontend
    -- ══════════════════════════════════════════════════════════════
    RETURN json_build_object(
        'success', true,
